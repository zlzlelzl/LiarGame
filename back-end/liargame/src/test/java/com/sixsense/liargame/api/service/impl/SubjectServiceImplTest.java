...
class SubjectServiceImplTest {
    ...
    void selectAllSubjects() {
        List<SubjectDto> subjectDtos = subjectService.selectAllSubjects();
        assertEquals(subjectDtos.get(0).getName(), "직업");
        assertEquals(subjectDtos.get(1).getName(), "식물");
        assertEquals(subjectDtos.get(2).getName(), "동물");
        assertEquals(subjectDtos.get(3).getName(), "운동");
        assertEquals(subjectDtos.get(4).getName(), "게임");
        assertEquals(subjectDtos.get(5).getName(), "음식");

        assertEquals(subjectDtos.get(0).getId(), 1L);
        assertEquals(subjectDtos.get(1).getId(), 2L);
        assertEquals(subjectDtos.get(2).getId(), 3L);
        assertEquals(subjectDtos.get(3).getId(), 4L);
        assertEquals(subjectDtos.get(4).getId(), 5L);
        assertEquals(subjectDtos.get(5).getId(), 6L);
    }
    ...
    void selectRandomWord() {
        WordDto wordDto = subjectService.selectRandomWord(1L);
        assertTrue(wordDto.getName().equals("경찰") || wordDto.getName().equals("소방관") || wordDto.getName().equals("변호사") || wordDto.getName().equals("개발자"));
        wordDto = subjectService.selectRandomWord(1L);
        assertTrue(wordDto.getName().equals("경찰") || wordDto.getName().equals("소방관") || wordDto.getName().equals("변호사") || wordDto.getName().equals("개발자"));
        wordDto = subjectService.selectRandomWord(1L);
        assertTrue(wordDto.getName().equals("경찰") || wordDto.getName().equals("소방관") || wordDto.getName().equals("변호사") || wordDto.getName().equals("개발자"));
        wordDto = subjectService.selectRandomWord(1L);
        ...
        wordDto = subjectService.selectRandomWord(2L);
        assertTrue(wordDto.getName().equals("해바라기") || wordDto.getName().equals("진달래") || wordDto.getName().equals("고구마") || wordDto.getName().equals("감자"));
        wordDto = subjectService.selectRandomWord(2L);
        assertTrue(wordDto.getName().equals("해바라기") || wordDto.getName().equals("진달래") || wordDto.getName().equals("고구마") || wordDto.getName().equals("감자"));
        wordDto = subjectService.selectRandomWord(2L);
        assertTrue(wordDto.getName().equals("해바라기") || wordDto.getName().equals("진달래") || wordDto.getName().equals("고구마") || wordDto.getName().equals("감자"));
        ...
        wordDto = subjectService.selectRandomWord(3L);
        assertTrue(wordDto.getName().equals("코끼리") || wordDto.getName().equals("사자") || wordDto.getName().equals("호랑이") || wordDto.getName().equals("토끼"));
        wordDto = subjectService.selectRandomWord(3L);
        assertTrue(wordDto.getName().equals("코끼리") || wordDto.getName().equals("사자") || wordDto.getName().equals("호랑이") || wordDto.getName().equals("토끼"));
        wordDto = subjectService.selectRandomWord(3L);
        assertTrue(wordDto.getName().equals("코끼리") || wordDto.getName().equals("사자") || wordDto.getName().equals("호랑이") || wordDto.getName().equals("토끼"));
        ...
        wordDto = subjectService.selectRandomWord(4L);
        assertTrue(wordDto.getName().equals("야구") || wordDto.getName().equals("축구") || wordDto.getName().equals("탁구") || wordDto.getName().equals("농구"));
        wordDto = subjectService.selectRandomWord(4L);
        assertTrue(wordDto.getName().equals("야구") || wordDto.getName().equals("축구") || wordDto.getName().equals("탁구") || wordDto.getName().equals("농구"));
        wordDto = subjectService.selectRandomWord(4L);
        assertTrue(wordDto.getName().equals("야구") || wordDto.getName().equals("축구") || wordDto.getName().equals("탁구") || wordDto.getName().equals("농구"));
        ...
        wordDto = subjectService.selectRandomWord(5L);
        assertTrue(wordDto.getName().equals("롤") || wordDto.getName().equals("에이펙스") || wordDto.getName().equals("배그") || wordDto.getName().equals("로아"));
        wordDto = subjectService.selectRandomWord(5L);
        assertTrue(wordDto.getName().equals("롤") || wordDto.getName().equals("에이펙스") || wordDto.getName().equals("배그") || wordDto.getName().equals("로아"));
        wordDto = subjectService.selectRandomWord(5L);
        assertTrue(wordDto.getName().equals("롤") || wordDto.getName().equals("에이펙스") || wordDto.getName().equals("배그") || wordDto.getName().equals("로아"));
        ...
        wordDto = subjectService.selectRandomWord(6L);
        assertTrue(wordDto.getName().equals("떡볶이") || wordDto.getName().equals("닭갈비") || wordDto.getName().equals("초밥") || wordDto.getName().equals("돈까스"));
