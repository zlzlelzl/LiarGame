...
class HistoryServiceImplTest {
    ...
    void normalGame(Long userId, String role, String winner, long start) {
        List<com.sixsense.liargame.common.model.request.GameUserDto> list = new ArrayList<>();
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(userId, role));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start, CITIZEN));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 1, CITIZEN));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 2, CITIZEN));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 3, CITIZEN));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 4, role.equals(LIAR) ? CITIZEN : LIAR));
    ...
    void spyGame(Long userId, String role, String winner, long start) {
        ...
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 1, CITIZEN));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 2, CITIZEN));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 3, role.equals(SPY) ? CITIZEN : SPY));
        list.add(new com.sixsense.liargame.common.model.request.GameUserDto(start + 4, role.equals(LIAR) ? CITIZEN : LIAR));
    ...
    void getNormalGameHistory() {
        ...
        List<GameUserDto> users = historyResp.getUsers();
        assertEquals(users.get(0), new GameUserDto(30L - idx, "테스트" + (30 - idx), CITIZEN));
        assertEquals(users.get(1), new GameUserDto(31L - idx, "테스트" + (31 - idx), CITIZEN));
        assertEquals(users.get(2), new GameUserDto(32L - idx, "테스트" + (32 - idx), CITIZEN));
        assertEquals(users.get(3), new GameUserDto(33L - idx, "테스트" + (33 - idx), CITIZEN));
        assertEquals(users.get(4), new GameUserDto(34L - idx, "테스트" + (34 - idx), CITIZEN));
        idx++;
        ...
        assertEquals(users.get(2), new GameUserDto(32L - idx, "테스트" + (32 - idx), CITIZEN));
        assertEquals(users.get(3), new GameUserDto(33L - idx, "테스트" + (33 - idx), CITIZEN));
        assertEquals(users.get(4), new GameUserDto(34L - idx, "테스트" + (34 - idx), LIAR));
        idx++;
        historyResp = normalGameHistory.get(idx);
        assertEquals(historyResp.getRole(), CITIZEN);
        assertEquals(historyResp.getResult(), getResult(historyResp, CITIZEN));
    ...
    void getSpyGameHistory() {
        ...
        assertEquals(historyResp.getResult(), getResult(historyResp, CITIZEN));
        List<GameUserDto> users = historyResp.getUsers();
        assertEquals(users.get(0), new GameUserDto(71L - idx, "테스트" + (71 - idx), CITIZEN));
        assertEquals(users.get(1), new GameUserDto(72L - idx, "테스트" + (72 - idx), CITIZEN));
        assertEquals(users.get(2), new GameUserDto(73L - idx, "테스트" + (73 - idx), CITIZEN));
        assertEquals(users.get(3), new GameUserDto(74L - idx, "테스트" + (74 - idx), SPY));
        assertEquals(users.get(4), new GameUserDto(75L - idx, "테스트" + (75 - idx), CITIZEN));
        idx++;
        ...
        assertEquals(users.get(2), new GameUserDto(73L - idx, "테스트" + (73 - idx), CITIZEN));
        assertEquals(users.get(3), new GameUserDto(74L - idx, "테스트" + (74 - idx), SPY));
        assertEquals(users.get(4), new GameUserDto(75L - idx, "테스트" + (75 - idx), LIAR));
        idx++;
        historyResp = spyGameHistory.get(idx);
        assertEquals(historyResp.getRole(), LIAR);
        assertEquals(historyResp.getResult(), getResult(historyResp, LIAR));
        ...
        assertEquals(users.get(1), new GameUserDto(72L - idx, "테스트" + (72 - idx), CITIZEN));
        assertEquals(users.get(2), new GameUserDto(73L - idx, "테스트" + (73 - idx), CITIZEN));
        assertEquals(users.get(3), new GameUserDto(74L - idx, "테스트" + (74 - idx), CITIZEN));
        assertEquals(users.get(4), new GameUserDto(75L - idx, "테스트" + (75 - idx), LIAR));
        idx++;
        historyResp = spyGameHistory.get(idx);
        assertEquals(historyResp.getRole(), CITIZEN);
