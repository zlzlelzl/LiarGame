        ...
        <table class="usertable thead-dark" style="margin: 0 auto">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  v-bind:disabled="!isinputActive"
                /><button id="namebtn" @click="namedupli">변경</button>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <input type="password" v-model="remodifyPW" />
                <button id="pwbtn" @click="patchPW">수정</button>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    userInfo() {
      ...
      axios({
        ...
        .then((res) => {
          ...
          this.spyhistory =
            this.spyplayed + "전 " + this.spywin + "승 " + this.spylose + "패";
        })
        .catch((err) => {
          console.log("스파이모드실패");
          console.log(err);
